...
//Math functions
	...
	inline
		static void Matrix4fMulMatrix4f(Matrix4fT* NewObj,  Matrix4fT* m1)
	{
		Matrix4fT Result; //safe not to initialize

		assert(NewObj && m1);

		// alias-safe way.
		Result.s.M00 = (NewObj->s.M00 * m1->s.M00) + (NewObj->s.M01 * m1->s.M10) + (NewObj->s.M02 * m1->s.M20) +  (NewObj->s.M03 * m1->s.M30);
		Result.s.M01 = (NewObj->s.M00 * m1->s.M01) + (NewObj->s.M01 * m1->s.M11) + (NewObj->s.M02 * m1->s.M21) +  (NewObj->s.M03 * m1->s.M31);
		Result.s.M02 = (NewObj->s.M00 * m1->s.M02) + (NewObj->s.M01 * m1->s.M12) + (NewObj->s.M02 * m1->s.M22) +  (NewObj->s.M03 * m1->s.M32);
		Result.s.M03 = (NewObj->s.M00 * m1->s.M03) + (NewObj->s.M01 * m1->s.M13) + (NewObj->s.M02 * m1->s.M23) +  (NewObj->s.M03 * m1->s.M33);

		Result.s.M10 = (NewObj->s.M10 * m1->s.M00) + (NewObj->s.M11 * m1->s.M10) + (NewObj->s.M12 * m1->s.M20) +  (NewObj->s.M13 * m1->s.M30);
		Result.s.M11 = (NewObj->s.M10 * m1->s.M01) + (NewObj->s.M11 * m1->s.M11) + (NewObj->s.M12 * m1->s.M21) +  (NewObj->s.M13 * m1->s.M31);
		Result.s.M12 = (NewObj->s.M10 * m1->s.M02) + (NewObj->s.M11 * m1->s.M12) + (NewObj->s.M12 * m1->s.M22) +  (NewObj->s.M13 * m1->s.M32);
		Result.s.M13 = (NewObj->s.M10 * m1->s.M03) + (NewObj->s.M11 * m1->s.M13) + (NewObj->s.M12 * m1->s.M23) +  (NewObj->s.M13 * m1->s.M33);


		Result.s.M20 = (NewObj->s.M20 * m1->s.M00) + (NewObj->s.M21 * m1->s.M10) + (NewObj->s.M22 * m1->s.M20) +  (NewObj->s.M23 * m1->s.M30);
		Result.s.M21 = (NewObj->s.M20 * m1->s.M01) + (NewObj->s.M21 * m1->s.M11) + (NewObj->s.M22 * m1->s.M21) +  (NewObj->s.M23 * m1->s.M31);
		Result.s.M22 = (NewObj->s.M20 * m1->s.M02) + (NewObj->s.M21 * m1->s.M12) + (NewObj->s.M22 * m1->s.M22) +  (NewObj->s.M23 * m1->s.M32);
		Result.s.M23 = (NewObj->s.M20 * m1->s.M03) + (NewObj->s.M21 * m1->s.M13) + (NewObj->s.M22 * m1->s.M23) +  (NewObj->s.M23 * m1->s.M33);


		Result.s.M30 = (NewObj->s.M30 * m1->s.M00) + (NewObj->s.M31 * m1->s.M10) + (NewObj->s.M32 * m1->s.M20) +  (NewObj->s.M33 * m1->s.M30);
		Result.s.M31 = (NewObj->s.M30 * m1->s.M01) + (NewObj->s.M31 * m1->s.M11) + (NewObj->s.M32 * m1->s.M21) +  (NewObj->s.M33 * m1->s.M31);
		Result.s.M32 = (NewObj->s.M30 * m1->s.M02) + (NewObj->s.M31 * m1->s.M12) + (NewObj->s.M32 * m1->s.M22) +  (NewObj->s.M33 * m1->s.M32);
		Result.s.M33 = (NewObj->s.M30 * m1->s.M03) + (NewObj->s.M31 * m1->s.M13) + (NewObj->s.M32 * m1->s.M23) +  (NewObj->s.M33 * m1->s.M33);
